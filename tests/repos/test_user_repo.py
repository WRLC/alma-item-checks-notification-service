...
class TestUserRepository:
    ...
    def test_get_user_email_no_result_found(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert email is None
            mock_logging.error.assert_called_with("UserRepository::get_user_email(): user not found")
    ...
    def test_get_user_email_sqlalchemy_error(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert email is None
            mock_logging.error.assert_called_with(f"UserRepository::get_user_email(): {error_msg}")
