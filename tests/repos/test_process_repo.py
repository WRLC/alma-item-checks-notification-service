...
class TestProcessRepository:
    ...
    def test_get_process_by_name_logs_not_found(self, mock_logging, db_session):
        ...
        assert process is None
        mock_logging.error.assert_called_with(f"ProcessRepository::get_process_by_name: {process_name} not found")
    ...
    def test_get_process_by_name_no_result_found(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert process is None
            mock_logging.error.assert_called_with(f"ProcessRepository.get_process_id_by_name: No process found with name '{process_name}'")
    ...
    def test_get_process_by_name_sqlalchemy_error(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert process is None
            mock_logging.error.assert_called_with(f"ProcessRepository.get_process_id_by_name: SQLAlchemyError: {error_msg}")
    ...
    def test_get_process_by_name_general_exception(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert process is None
            mock_logging.error.assert_called_with(f"ProcessRepository.get_process_id_by_name: Exception: {error_msg}")
    ...
    def test_get_process_id_by_name_logs_not_found(self, mock_logging, db_session):
        ...
        assert process_id is None
        mock_logging.error.assert_called_with(f"ProcessRepository.get_process_id_by_name: Process '{process_name}' not found")
