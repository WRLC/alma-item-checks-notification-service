...
class TestUserProcessRepository:
    ...
    def test_get_users_for_process_no_result_found(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            mock_logging.error.assert_called_with("UserProcessRepository.get_users_for_process: NoResultFound")
    ...
    def test_get_users_for_process_sqlalchemy_error(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert user_ids is None
            mock_logging.error.assert_called_with(f"UserProcessRepository.get_users_for_process: SQLAlchemyError: {error_msg}")
    ...
    def test_get_users_for_process_general_exception(self, mock_logging, db_session):
        ...
        with patch.object(db_session, 'execute') as mock_execute:
            ...
            assert user_ids is None
            mock_logging.error.assert_called_with(f"UserProcessRepository.get_users_for_process: Exception: {error_msg}")
    
    def test_get_users_for_process_returns_integers(self, db_session, sample_user_process):
